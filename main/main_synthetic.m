...
(*from matrix it gets h0 for patterns that |h0|>1, ({h,n,pM,z,+-1,patt}) h0goodpatt[tab_,hcutoff_:1.,Nmax_:10000]*)
(*DumpGet[ dirscr <> "h0goodpatt.mx"]*)
DumpGet[ dirscr <> "h0goodpatt2.mx"]
...
(*gets significance level from reshuffling data, needs previous func, {mc1,mc2,mc3,mc5}=signlevel[mat_,iopt_,nmix_:5,ne_:20,hcutoff_:1,Nmax=10000]*)
DumpGet[ dirscr <> "signlevel.mx"]
(*DumpGet[ dirscr <> "signlevellower2.mx"]
DumpGet[ dirscr <> "signlevellower4.mx"]*)
(*Counting the number of true patt detected, and similar patt detected, {td,sim}=truesimdetected[orig_,guess_]*)
DumpGet[ dirscr <> "truesimdetected.mx"]
